...
* **Service Flow:** The device initiates a check-in &rarr; Intune evaluates applicable policies &rarr; settings are delivered via the MDM channel or IME &rarr; the device executes the settings and reports success or failure back to the portal.
